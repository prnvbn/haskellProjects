...
diffTests
  = [ (e1, "x") ==> Val 5.0
    ...
    , (e2, "y") ==> Val 1.0
    , (e4, "x") ==> UnApp Neg (UnApp Neg (UnApp Sin (Id "x")))
    , (e5, "x") ==> BinApp Mul (UnApp Cos (BinApp Add (Val 1.0) (UnApp Log (BinApp Mul (Val 2.0) (Id "x"))))) (BinApp Div (Val 2.0) (BinApp Mul (Val 2.0) (Id "x")))
    , (e6, "x") ==> BinApp Div (BinApp Mul (Val 3.0) (BinApp Add (Id "x") (Id "x"))) (BinApp Add (BinApp Mul (Val 3.0) (BinApp Mul (Id "x") (Id "x"))) (Val 2.0))
    , ((UnApp Log x), "x") ==> BinApp Div (Val 1.0) (Id "x")
    ]
